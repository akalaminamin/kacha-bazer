    ...
    return (
        <div className="">
            <div className="aboutbanner ">
                <h3 className="text-3xl  "style={{color:"red"}}>About US</h3>
            </div>
            <div className=' '>
            <div className='grid grid-rows grid-cols-2 gap-4'>
                <div className='  mt-3'>
                    <h1 className=' text-3xl mt-3 mb-3'>Welcome to KachaBazar</h1>
                    <p className='ms-3  text-left'>Holisticly seize parallel metrics and functional ROI. Seamlessly revolutionize error-free internal or "organic" sources before effective scenarios. Progressively incentivize state of the art applications for efficient intellectual capital. Credibly leverage existing distinctive mindshare through cutting-edge schemas. Proactively procrastinate team building paradigms coordinate client-centric total transparent internal.</p>
                    <p className='ml-3 text-left '>Dynamically embrace diverse customer service and installed base paradigms. Credibly seize enterprise-wide experiences for end-to-end data. Professionally brand flexible alignments and cost effective architectures. Enthusiastically incentivize seamless communities with seamlessly facilitate revolutionary metrics with strategic theme areas.</p>
                    <div className='grid grid-rows grid-cols-2 gap-4 '>
                        <div className='bg-gray-300 mt-5'>
                            <h4 className='text-2xl  '>10K</h4>
                            <h6>Listed Products</h6>
                            <p>Dynamically morph team driven partnerships after vertical.</p>
                        </div>
                        <div className='bg-gray-300 mt-5 h-36'>
                            <h4 className='text-2xl  '>8K</h4>
